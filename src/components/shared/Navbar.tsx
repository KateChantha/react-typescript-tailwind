...
const Navbar = () => {
  // open/close "More" menu dropbox
  const [isActive, setIsActive] = useState(false);
  // toggle navbar on mobile screen
  const [isOpen, setIsOpen] = useState(false)

  // Event Handler, when click outside menu
        ...
        <div className="relative flex items-center justify-between h-16">
          ...
          <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div className="hidden sm:block sm:ml-6">
              <div className="flex space-x-4">
                ...
                <NavLink exact to="/" className="bg-green-500 text-white hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium" activeClassName="bg-green-500">
                  Home
                </NavLink>
          ...
          <div className={`${isOpen ? "block": "hidden"} sm:hidden`} id="mobile-menu">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <button  type="button" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 inline-flex rounded-md text-sm font-medium" aria-expanded="false" onClick={() =>{
                console.log("click")
